...
def create_model():
    myInput = Input(shape=(96, 96, 6))

    x = ZeroPadding2D(padding=(3, 3), input_shape=(96, 96, 6))(myInput)
    ...
    dropout = Dropout(0.9)(dense_layer)
    decision = Dense(2, activation='softmax', name='decision')(dropout)
    
    #norm_layer = Lambda(lambda  x: K.l2_normalize(x, axis=1), name='norm_layer')(dense_layer)

    return Model(inputs=[myInput], outputs=decision)
